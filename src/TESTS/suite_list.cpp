...
TEST(List, Operator_Copy) {
  s21::list<int> our_list = {1, 2, 3};
  s21::list<int> our_copy(our_list);
  EXPECT_EQ(our_copy.front(), our_list.front());
  EXPECT_EQ(our_copy.back(), our_list.back());
}
...
TEST(List, Swap) {
  s21::list<int> our_list = {1, 2, 3};
  s21::list<int> their_list = {3, 2, 1};
  our_list.swap(their_list);
  EXPECT_EQ(our_list.front(), 3);
  EXPECT_EQ(their_list.front(), 1);
}
